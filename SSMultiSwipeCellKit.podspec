#
#  Be sure to run `pod spec lint SSMultiSwipeCellKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Nishchal Visavadiya" => "nishchal.v@simformsolutions.com" }
  # Or just: spec.author    = "Nishchal Visavadiya"
  # spec.authors            = { "Nishchal Visavadiya" => "nishchal.v@simformsolutions.com" }
  # spec.social_media_url   = "https://twitter.com/Nishchal Visavadiya"
